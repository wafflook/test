...
var NumberControllerSlider = function (_NumberController) {
  ...
  function NumberControllerSlider(object, property, min, max, step, empty) {
    classCallCheck(this, NumberControllerSlider);
    var _this2 = possibleConstructorReturn(this, (NumberControllerSlider.__proto__ || Object.getPrototypeOf(NumberControllerSlider)).call(this, object, property, { min: min, max: max, step: step, empty: empty }));
    var _this = _this2;
...
var TextController = function (_Controller) {
  inherits(TextController, _Controller);
  function TextController(object, property) {
    classCallCheck(this, TextController);
    var _this2 = possibleConstructorReturn(this, (TextController.__proto__ || Object.getPrototypeOf(TextController)).call(this, object, property));
    var _this = _this2;
    function onChange() {
      _this.setValue(_this.__input.value);
    }
    ...
    _this2.__input.setAttribute('spellcheck', 'false');
    dom.bind(_this2.__input, 'keyup', onChange);
    dom.bind(_this2.__input, 'change', onChange);
    dom.bind(_this2.__input, 'blur', onBlur);
    _this2.updateDisplay();
  ...
  createClass(TextController, [{
    key: 'updateDisplay',
    value: function updateDisplay() {
      if (!dom.isActive(this.__input)) {
        this.__input.value = this.getValue();
      }
      return get(TextController.prototype.__proto__ || Object.getPrototypeOf(TextController.prototype), 'updateDisplay', this).call(this);
    }
  }]);
...
var plotter = function plotter(fg, bg, type, width, height) {
...
var PlotterController = function (_Controller) {
  ...
  function PlotterController(object, property, params) {
    ...
    _this.update = function () {
      self.__panel = new plotter(params.fgColor, params.bgColor, params.type, self.domElement.clientWidth || 160, 60);
      if (self.domElement.firstChild) {
        self.domElement.replaceChild(self.__panel.dom, self.domElement.firstChild);
      } else {
        self.domElement.appendChild(self.__panel.dom);
      }
    };
...
var ImageController = function (_Controller) {
  ...
  function ImageController(object, property) {
    ...
    var _this2 = possibleConstructorReturn(this, (ImageController.__proto__ || Object.getPrototypeOf(ImageController)).call(this, object, property));
    _this2.__onChangeFirstTime = true;
  ...
  createClass(ImageController, [{
    ...
    value: function updateDisplay() {
      ...
      return get(ImageController.prototype.__proto__ || Object.getPrototypeOf(ImageController.prototype), 'updateDisplay', this).call(this);
    }
  }]);
...
{
  addObject: function addObject(recursiveObject, folderName, guiElement) {
    if (guiElement === undefined) {
      guiElement = this;
      if (folderName === undefined) {
        folderName = "object root " + Math.random().toString(36).substring(12);
      }
    }
    var folder = guiElement.addFolder(folderName);
    var _iteratorNormalCompletion = true;
    var _didIteratorError = false;
    var _iteratorError = undefined;
    try {
      for (var _iterator = Object.keys(recursiveObject)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var v = _step.value;
        if (_typeof(recursiveObject[v]) === "object") {
          guiElement.addObject(recursiveObject[v], v, folder);
        } else {
          folder.add(recursiveObject, v);
        }
      }
    } catch (err) {
  ...
  addPlotter: function addPlotter(object, property, max, period, type, fgColor, bgColor) {
    return _add(this, object, property, {
      ...
      type: type || 'line',
      fgColor: fgColor || '#1ed36f',
      bgColor: bgColor || '#303030'
    });
  },
  ...
  addText: function addText(object, property) {
    return _add(this, object, property, {
      text: true
    });
  },
    ...
    Common.each(this.__controllers, function (controller) {
      switch (true) {
        ...
        case controller instanceof TextController:
          if (enable) {
            dom.addClass(controller.__li, 'expand');
          } else {
            dom.removeClass(controller.__li, 'expand');
          }
          break;
      }
      switch (true) {
  ...
  Common.extend(controller, {
    ...
    type: function type(v) {
      switch (true) {
        case controller instanceof StringController:
        case controller instanceof TextController:
          dom.addClass(controller.__input, v);
          break;
      }
      return controller;
    },
    ...
    readonly: function readonly(enable) {
      switch (true) {
        ...
        case controller instanceof StringController:
        case controller instanceof TextController:
          controller.__input.readOnly = enable;
          break;
      }
      return controller;
    },
    ...
    password: function password(enable) {
      switch (true) {
        case controller instanceof StringController:
          controller.__input.type = enable ? 'password' : 'text';
          controller.__input.autocomplete = 'new-password';
          break;
      }
      return controller;
    }
...
function _add(gui, object, property, params) {
  ...
  if (params.color) {
    ...
    controller = new TextController(object, property);
  } else {
